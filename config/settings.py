...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'config.context_processors.all_category',
            ],
        },
    },
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "My print adminstration",
    ...
    "welcome_sign": "Welcome to the MYPRINT.UZ",
    ...
    "hide_models": [ 'myprint.Category', 'myprint.User', 'myprint.AboutImage', 'myprint.About', 'myprint.Settings', 'myprint.TypeService', 'myprint.Customer'],
